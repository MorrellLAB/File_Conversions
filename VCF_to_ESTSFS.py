...
def est_vcf_convert(bed_file1, bed_file2, vcf_file, output_file, bed_file3=None):
    ...
    with open(output_file, "w") as outfile:
        for i in range(len(bed_file1)): 
            ...
            genotypes = [] 
            for j in range(len(genotypesAlternate)):  #puts together genotypes referece and alleles use as a string in the output.
            ...
            if len(sys.argv) == 6: #Uses this output if there were three bedfiles intputted
